    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md mx-auto px-6 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mb-2">SRM MUN Society</h1>
          <p className="text-gray-300 text-sm">Be a part of the legacy!</p>
        </div>

        {/* Social Links */}
        <div className="flex justify-center gap-6 mb-8">
          <a href="https://www.linkedin.com/company/srm-mun-society/posts/?feedView=all" className="text-gray-300 hover:text-white transition-colors">
            <Linkedin size={24} />
          </a>
          <a href="https://www.instagram.com/srm_munsoc/" className="text-gray-300 hover:text-white transition-colors">
          ...
          <a href="https://chat.whatsapp.com/E3QCqwsKrSCD4YIV9SnUNZ" className="text-gray-300 hover:text-white transition-colors">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
